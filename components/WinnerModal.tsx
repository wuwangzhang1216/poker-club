...
const WinnerModal: React.FC<WinnerModalProps> = ({ winners, hand }) => {
  ...
  return (
    <div className="absolute inset-0 bg-black bg-opacity-80 flex items-center justify-center z-[100]">
      <div className="bg-[#1A1A1A] border-4 border-transparent rounded-xl p-8 text-center shadow-2xl animate-fade-in-down shadow-black/70"
        ...
        <p className="text-2xl text-[#F7E7CE]">
          with a {hand}
        </p>
      </div>
       <style>{`
