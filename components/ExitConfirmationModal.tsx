  ...
  return (
    <div className="absolute inset-0 bg-black bg-opacity-80 flex items-center justify-center z-[100] p-4">
      <div className="bg-[#1A1A1A] border-4 border-transparent rounded-xl p-6 sm:p-8 text-center shadow-2xl animate-fade-in-down shadow-black/70 w-full max-w-md"
        ...
        <p className="text-base sm:text-lg text-[#CCCCCC] mb-8">
          Are you sure you want to quit? All current game progress will be lost.
        </p>
        <div className="flex space-x-4">
             <button
                onClick={onCancel}
                className="w-full py-3 text-base sm:text-lg action-button secondary"
            >
                Cancel
            </button>
            <button
                onClick={onConfirm}
                className="w-full py-3 text-base sm:text-lg action-button primary"
            >
                Confirm
            </button>
        </div>
